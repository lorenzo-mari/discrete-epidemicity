...
set(gca,'XLim',[0 wind],'XTick',0:30:wind,'YLim',[0.5 2.25],'YTick',0.5:0.5:2,'TickDir','out','TickLabelInterpreter','latex')
...
text(dur_1-3,ae_1(dur_1+1)+0.08,'$(k_{\mathrm{end}},1)$','Interpreter','latex','FontSize',10,'HorizontalAlignment','center','VerticalAlignment','bottom')

nexttile
hold on
plot(R_vect,E_1_vect,'LineWidth',1,'Color',cols(1,:))
plot(R_vect,A_1_vect,'LineWidth',1,'Color',cols(2,:))
set(gca,'XLim',[0 1],'XTick',0:0.2:1,'YLim',[0.5 2],'YTick',0.5:0.5:2,'TickDir','out','TickLabelInterpreter','latex')
...
set(gcf,'NumberTitle','off','Name','Figure S2')
